    ...
    <div className="min-h-screen text-[var(--text)] bg-[var(--bg)] font-sans selection:bg-[var(--terra)] selection:text-[var(--surface)]">
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 font-sans font-medium text-[15px]">
          ...
          <a href="#servicios" className="hover:text-[var(--terra)] transition-colors">Servicios</a>
      ...
      <section id="servicios" ref={servicesRef} className="py-[120px] px-[8%] max-w-[1440px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-[80px]">
          ...
          <div className="lg:w-[62%] flex flex-col gap-3">
            {[
              { num: '01', title: 'SEO Local (Google Maps)', desc: 'Aparece en el top 3 cuando alguien busca lo que tú vendes.' },
              { num: '02', title: 'Google Ads', desc: 'Llega a clientes que ya están buscando tus servicios ahora mismo.' },
              { num: '03', title: 'Facebook & Instagram Ads', desc: 'Publicidad que llega a las personas correctas en tu zona.' },
              { num: '04', title: 'Páginas Web', desc: 'Tu sitio más rápido, claro, y construido para generar contactos.' }
            ].map((service, idx) => (
              <div key={idx} className="service-card group bg-[var(--surface)] rounded-[16px] shadow-[0_2px_20px_rgba(26,26,24,0.06)] p-6 md:px-7 md:py-6 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all duration-300 hover:-translate-y-[3px] border-l-[3px] border-transparent hover:border-[var(--terra)]">
                <div className="flex items-start md:items-center gap-6">
                  <span className="font-mono text-[11px] text-[var(--muted)]">{service.num}</span>
                  <div>
                    <h3 className="font-sans font-bold text-[20px] text-[var(--text)] mb-1">{service.title}</h3>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-[48px]">
            ...
            <div>
              ...
              <p className="font-sans font-light text-[14px] text-[rgba(245,240,232,0.55)]">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3">
                <li><a href="#" className="font-sans font-light text-[14px] text-[rgba(245,240,232,0.55)] hover:text-[#F5F0E8] transition-colors">SEO Local</a></li>
                <li><a href="#" className="font-sans font-light text-[14px] text-[rgba(245,240,232,0.55)] hover:text-[#F5F0E8] transition-colors">Google Ads</a></li>
                ...
                <li><a href="#" className="font-sans font-light text-[14px] text-[rgba(245,240,232,0.55)] hover:text-[#F5F0E8] transition-colors">Páginas Web</a></li>
              </ul>
            </div>
